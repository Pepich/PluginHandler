...
public class Main
{
	public static File rootDirectorie;
	...
	public static void main(String[] args) throws URISyntaxException
	{
		...
		rootDirectorie  = new File(Main.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()).getParentFile();
		Logger.info("Base server is located at: " + Main.class.getProtectionDomain().getCodeSource().getLocation().toString(), "main");
		File plugins = new File(rootDirectorie.getPath() + "/plugins");
